...
describe('UserCadComponent', () => {
  ...
  it('all fields should be required', () => {
    ...
    const contato = component.cadastroForm.controls['contato'];
    ...
    expect(contato.errors['required']).toBeTruthy();
  ...
  it('fields values should be stored correctly', () => {
    ...
    component.cadastroForm.controls['contato'].setValue(contato_teste);
    ...
    expect(component.cadastroForm.get('contato').value).toBe(contato_teste);
